local time_between_regen = tonumber(core.settings:get("myregenchest.food_time")) or 300
...
local item_spawn = function(pos, node)
	...
	core.set_node(pos, {name="myregenchest:food_chest_open", param2=node.param2})

	local timer = core.get_node_timer(pos)
		timer:start(time_between_regen)
		core.swap_node(pos, {name="myregenchest:food_chest_open", param2=node.param2})
end
...
core.register_node("myregenchest:food_chest", {
...
core.register_node("myregenchest:food_chest_open", {
	...
	core.swap_node(pos, {name = "myregenchest:food_chest", param2=node.param2})
